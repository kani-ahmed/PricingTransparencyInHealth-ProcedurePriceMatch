...
def main(folder_path):
    ...
    for key_names, filenames in same_key_names.items():
        print(f"Key names: {key_names}, Count: {len(filenames)}, Files: {filenames}")
...
# Example usage
folder_path = r'C:\Users\purru\Desktop\PricingTransparencyInHealth-ProcedurePriceMatch\different_keys_json_files'
main(folder_path)
